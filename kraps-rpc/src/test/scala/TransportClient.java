...
/**
 * Client for fetching consecutive chunks(连续的块) of a pre-negotiated(预先商定的) stream. This API is intended to allow
 * efficient transfer of a large amount of data, broken up into chunks with size ranging from
 * hundreds of KB to a few MB.(这个api是高效传输的，对于大数据切分为小块数据)
 * <p/>
 ...
 * <p/>
 * Construct an instance of TransportClient using {@link org.apache.spark.network.client.TransportClientFactory}. A single
